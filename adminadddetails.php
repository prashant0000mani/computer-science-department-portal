...
<label class="control-label">Whose Value you want to Add?</label><br />
...
if(isset($_POST['btnselect']))
{
    ...
    switch($a)
    {
        case 1: header("location:adminaddstudentdetails.php");
                    break;
        case 2: header("location:adminaddfacultydetails.php");
            break;
    }
}
